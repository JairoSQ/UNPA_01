---
title: Informe de Análisis de Parámetros de Well Testing utilizando Herramientas de R
author:
  - name: Jairo Sebastián Quiroga
    affil: UNSa,2,\ddagger,*
...
affiliation:
  - num: 1
    address: |
      ...
      Unidad Académica Caleta Oliva - Diplomatura Universitaria en Gestión y Tecnologías para el desarrollo Convencional y No Convencional de Hidrocarburos.
      Ruta Nacional 3, Z9011 Caleta Olivia, Santa Cruz - Argentina
    Telefono: 0297 485-4888
  - num: 2
    address: |
      Universidad Nacional de Salta
      Facultad Regional Multidisciplinar Tartagal - Ingenieria en Perforaciones.
      Ejército Argentino, A4560 Tartagal, Salta - Argentina
    Telefono: 03873 42-1182
# author citation list in chicago format
authorcitation: |
  Leutnant, D.; Doe, J.
# firstnote to eighthnote
firstnote: |
  Actividad: *Informe Final del Modulo III de la diplomatura de Hidrocarburos.*
secondnote: |
  Trabajo con datos reales y con interpretaciones, con el unico objetivo de culminar un informe final academico.
correspondence: |
  jairosq91@gmail.com; Tel.: 3873-401123.
# document options
...
# front matter
simplesummary: |
  Este trabajo aborda el análisis de parametros en una operacion de well testing.
abstract: |
  Resumen del trabajo
  ...
  headings: 1) Introducción: Place the question addressed in a broad context and
  highlight the purpose of the study; 2) Consideraciones a tener en cuenta: Describe briefly the main methods or treatments applied; 3) Resultados / caso de estudio: Summarize the article's main findings; and 4) Discusion Final y Conclusion: Indicate the main conclusions or interpretations. 
...
Los datos que usaremos para el aalisis deparametros 
...
# Results / Caso de Estudio

mescla de metodos y dataset
analisis
